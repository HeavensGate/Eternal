...
/area/asteroid/cave				// -- TLE
	name = "\improper Asteroid - Underground" // Interesting.
	icon_state = "cave"
	requires_power = 0
...
//PRISON
/area/prison
	name = "\improper Labor Camp Arrivals"
	icon_state = "brig"

/area/prison/control
	name = "\improper Labor Camp Security Checkpoint"
	icon_state = "security"

/area/prison/crew_quarters
	name = "\improper Labor Camp EVA Checkpoint"
	icon_state = "security"

/area/prison/rec_room
	name = "\improper Labor Camp Quarters"
	icon_state = "green"

/area/prison/medical_research
	name = "\improper Labor Camp Hydroponics"
	icon_state = "medresearch"

/area/prison/medical
	name = "\improper Labor Camp Medbay"
	icon_state = "medbay"

/area/prison/solar
	name = "\improper Labor Camp Engineering"
	icon_state = "storage"
